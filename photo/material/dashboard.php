                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title"><a href="menu.php"><b>Vendors List</b></a></h2>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="exampleModalLabel1">Add New Vendor</h4>
                        ...
                        <div class="card card-block">
                            ...
                            <form class="form-horizontal m-t-40" action="home.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter the Vendor name " name="Vendorname">
                                    <input type="hidden" name="vendorid" value="<?php echo $vendor_id?>">
                                </div>
                                <div class="form-group">
                                    <label>Contact</label>
                                    <input type="text" class="form-control" placeholder="Enter the ph. number" name="contact">
                                </div>
                                <div class="form-group">
                                    <label>Place</label>
                                ...
                                <div class="form-group">
                                    <label>Pincode</label>
                                    <input type="text" class="form-control" placeholder="Enter the Pincode" name="pincode">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" name="dishdesc"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="text" class="form-control" placeholder="Enter the Price at which you want to rent" name="dishprice">
                                </div>
                                ...
                                <h4 class="card-title">Add Product Images</h4>
                                    <div class="fallback">
                                        <input name="file" type="file" multiple name="dishimg">
                                    </div>
                                </div>        
...
<ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#closed" role="tab">Inactive</a> </li>
                                </ul>
                                <br>
                   ...
                   <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="card-title">dale steyn
                                </div>
                            </div>
                        </div>
                     </div>
