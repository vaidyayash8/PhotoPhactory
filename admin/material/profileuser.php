...
require 'db.php';
 ...
 $fetch=mysqli_query($conn,"SELECT * from profile")or die(mysqli_error());
...
$firstname = trim($_POST['first']);
       ...
       $sql="UPDATE profile SET firstname='$firstname',lastname='$lastname',email='$email',address='$address',city='$city',state='$state',zip='$zip',category='$category',image='$image',id='$id' WHERE email='$email'";
...
<!----------------------------------------settings----------------------------------->
   ...
   <?php                                    $fetch=mysqli_query($conn,"SELECT * from profile")or die(mysqli_error());
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <div class='col-md-12'>
                                                    <input type='text' value='$id' class='form-control form-control-line' name='id' id='example-email'>
                                                </div>
                                            </div>
